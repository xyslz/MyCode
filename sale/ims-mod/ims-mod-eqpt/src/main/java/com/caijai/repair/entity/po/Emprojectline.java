 ...
 *
 */
@Table(name = "eq_EMProjectLine")
public class Emprojectline extends BaseTable {

	private static final long serialVersionUID = 4059030337601081770L;
	 ...
	 * 行号
	 */
	@Column(name = "RowNO" ,sort = Sort.ASC)
	 ...
	 * 维修项目
	 */
	@Column(name = "EMProject")
	private String emproject;
	 ...
	 * 维修周期(天)
	 */
	@Column(name = "MaintainPeriod")
	private Double maintainperiod;

	/**
	 * 维修标准小时
	 */
	@Column(name = "MaintainHour")
	...
	public String getEmproject() {
		return emproject;
	}

	public void setEmproject(String emproject) {
	...
	public String toString() {
		return "Emprojectline [id=" + id + ", dr=" + dr + ", createdOn=" + createdOn + ", modifiedOn=" + modifiedOn
				...
				+ maintainmethod + ", memo=" + memo + ", maintainassort=" + maintainassort + ", rowno=" + rowno
				...
				+ ", descflexfieldPrivatedescseg30=" + descflexfieldPrivatedescseg30 + ", emproject=" + emproject
				+ ", sysversion=" + sysversion + ", lastmaintaindate=" + lastmaintaindate + ", maintainperiod="
				+ maintainperiod + ", maintainhour=" + maintainhour + ", maintaincoefficient=" + maintaincoefficient
				+ "]";
	}
}