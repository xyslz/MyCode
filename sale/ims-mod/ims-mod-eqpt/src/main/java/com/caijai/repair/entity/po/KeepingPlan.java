...
import com.caijai.base.sysenum.wx.PlanState;
 ...
 *
 */
@Table(name = "eq_KeepingPlan")
public class KeepingPlan extends BaseTable {

	private static final long serialVersionUID = 3664129262978668175L;
	 ...
	 * 使用部门
	 *//*
	@Column(name = "UseDepartment",readonly = true)
	@Relation(show = "id", table = "EQ_EM", value = "id",ref="EM")
	...
	*//**
	...
	@Relation(show = "name", table = "SYS_Department", value = "ID",ref="UseDepartment")
	 ...
	 * 配合部门
	 */
	@Column(name = "coordinatedptName",readonly = true)
	@Relation(show = "name", table = "SYS_Department", value = "ID",ref="CoordinateDpt")
	private String coordinatedptName;

	/**
	 * 保养负责人
	 */
	@Column(name = "KeepingCharge")
	private String keepingcharge;
	
	/**
	 * 保养负责人
	 */
	@Column(name="keepingchargeName",readonly = true)
	@Relation(show = "name", table = "SYS_Person", value = "id",ref="KeepingCharge")
	private String keepingchargeName;
	...
	public PlanState getDocstate() {
		return docstate;
	}

	public void setDocstate(PlanState docstate) {
	...
	public String getKeepingcharge() {
		return keepingcharge;
	}

	public void setKeepingcharge(String keepingcharge) {
		this.keepingcharge = keepingcharge;
	}
	...
	public String getKeepingchargeName() {
		return keepingchargeName;
	}

	public void setKeepingchargeName(String keepingchargeName) {
		this.keepingchargeName = keepingchargeName;
	}
	...
	public String toString() {
		return "KeepingPlan [id=" + id + ", dr=" + dr + ", fromdateplan=" + fromdateplan + ", todateplan=" + todateplan
				+ ", halttime=" + halttime + ", documenttype=" + documenttype + ", memo=" + memo + ", em=" + em
				+ ", emName=" + emName + ", docstate=" + docstate + ", approveinfoApprovedon=" + approveinfoApprovedon
				+ ", approveinfoUnapprovedon=" + approveinfoUnapprovedon + ", approveinfoApprovedby="
				+ approveinfoApprovedby + ", approveinfoUnapprovedby=" + approveinfoUnapprovedby + ", coordinatedpt="
				+ coordinatedpt + ", coordinatedptName=" + coordinatedptName + ", keepingcharge=" + keepingcharge
				+ ", keepingchargeName=" + keepingchargeName + ", flowinstance=" + flowinstance + ", createdOn="
				...
				+ ", version=" + version + ", printamount=" + printamount + ", org=" + org
				...
				+ sysversion + ", businessdate=" + businessdate + ", ts=" + ts + ", syssource=" + syssource + "]";
	}
