 ...
 *
 */
@Table(name = "eq_MiscShipL")
public class MiscshipL extends BaseTable {

	private static final long serialVersionUID = 4654800979190791685L;
	...
	public String toString() {
		return "MiscshipL [id=" + id + ", createdOn=" + createdOn + ", createdBy=" + createdBy + ", modifiedOn="
				+ modifiedOn + ", modifiedBy=" + modifiedBy + ", sysversion=" + sysversion + ", doclineno=" + doclineno
				+ ", wh=" + wh + ", whman=" + whman + ", ownerorg=" + ownerorg + ", customerinfoCustomer="
				+ customerinfoCustomer + ", customerinfoCode=" + customerinfoCode + ", customerinfoShortname="
				+ customerinfoShortname + ", supplierinfoSupplier=" + supplierinfoSupplier + ", supplierinfoCode="
				+ supplierinfoCode + ", supplierinfoShortname=" + supplierinfoShortname + ", manufacturerinfoSupplier="
				+ manufacturerinfoSupplier + ", manufacturerinfoCode=" + manufacturerinfoCode
				+ ", manufacturerinfoShortname=" + manufacturerinfoShortname + ", tradeuomqty=" + tradeuomqty
				+ ", storeuomqty=" + storeuomqty + ", tbutosburate=" + tbutosburate + ", costuomqty=" + costuomqty
				+ ", tbutocburate=" + tbutocburate + ", lotinfoLotcode=" + lotinfoLotcode + ", lotinfoDisabledstring="
				+ lotinfoDisabledstring + ", lotinfoLotmaster=" + lotinfoLotmaster + ", lotinfoLotvaliddate="
				+ lotinfoLotvaliddate + ", sobcurrency=" + sobcurrency + ", costprice=" + costprice + ", project="
				+ project + ", task=" + task + ", handlepsn=" + handlepsn + ", handledept=" + handledept
				+ ", benefitpsn=" + benefitpsn + ", benefitdept=" + benefitdept + ", assertcardno=" + assertcardno
				+ ", ismfg=" + ismfg + ", modocno=" + modocno + ", productdate=" + productdate + ", productline="
				+ productline + ", workprocno=" + workprocno + ", issueusage=" + issueusage + ", product=" + product
				+ ", productver=" + productver + ", productgrade=" + productgrade + ", productptc=" + productptc
				...
				+ ", descflexsegmentsPrivatedescseg30=" + descflexsegmentsPrivatedescseg30 + ", miscship=" + miscship
				+ ", assetcardid=" + assetcardid + ", org=" + org + ", costuom=" + costuom + ", costbaseuom="
				+ costbaseuom + ", cutocburate=" + cutocburate + ", storeuom=" + storeuom + ", storebaseuom="
				+ storebaseuom + ", sutosburate=" + sutosburate + ", tradeuom=" + tradeuom + ", tradebaseuom="
				+ tradebaseuom + ", tradebaseuomqty=" + tradebaseuomqty + ", tutotburate=" + tutotburate
				+ ", iteminfoItemid=" + iteminfoItemid + ", iteminfoItemname=" + iteminfoItemname
				+ ", iteminfoItemcode=" + iteminfoItemcode + ", iteminfoItemgrade=" + iteminfoItemgrade
				+ ", iteminfoItempotency=" + iteminfoItempotency + ", iteminfoItemopt1=" + iteminfoItemopt1
				+ ", iteminfoItemopt2=" + iteminfoItemopt2 + ", iteminfoItemopt3=" + iteminfoItemopt3
				+ ", iteminfoItemversion=" + iteminfoItemversion + ", iteminfoItemopt10=" + iteminfoItemopt10
				+ ", iteminfoItemopt4=" + iteminfoItemopt4 + ", iteminfoItemopt5=" + iteminfoItemopt5
				+ ", iteminfoItemopt6=" + iteminfoItemopt6 + ", iteminfoItemopt7=" + iteminfoItemopt7
				+ ", iteminfoItemopt8=" + iteminfoItemopt8 + ", iteminfoItemopt9=" + iteminfoItemopt9 + ", storetype="
				+ storetype + ", costmny=" + costmny + ", isvmi=" + isvmi + ", srcdoclinesysver=" + srcdoclinesysver
				+ ", iszerocost=" + iszerocost + ", sncode=" + sncode + ", voucherid=" + voucherid + ", voucherno="
				+ voucherno + ", vouchertypeid=" + vouchertypeid + ", isneedtogl=" + isneedtogl + ", istogl=" + istogl
				+ ", assetcardqty=" + assetcardqty + ", srcitemversion=" + srcitemversion + ", modocentityEntityid="
				+ modocentityEntityid + ", modocentityEntitytype=" + modocentityEntitytype
				...
				+ seibancode + ", rcvqty=" + rcvqty + ", rcvqtytime=" + rcvqtytime + ", storemainuom=" + storemainuom
				+ ", storesubuom=" + storesubuom + ", sutosmurate=" + sutosmurate + ", sutocurate=" + sutocurate
				+ ", storemainuomqty=" + storemainuomqty + ", smutosmburate=" + smutosmburate + ", node=" + node
				+ ", bomlineno=" + bomlineno + ", aaistatus=" + aaistatus + ", isneedgenaai=" + isneedgenaai
				+ ", usereturnmny=" + usereturnmny + ", isgernertbd=" + isgernertbd + ", attribute=" + attribute
				+ ", hasrcvqty=" + hasrcvqty + ", plsentityEntityid=" + plsentityEntityid + ", plsentityEntitytype="
				+ plsentityEntitytype + ", pls=" + pls + ", isinnerbalance=" + isinnerbalance + ", benefitorg="
				+ benefitorg + ", benefitownerorg=" + benefitownerorg + ", balanceroute=" + balanceroute
				+ ", benefitwh=" + benefitwh + ", benefitbinBin=" + benefitbinBin + ", benefitbinCode=" + benefitbinCode
				+ ", benefitbinName=" + benefitbinName + ", benefitproject=" + benefitproject + ", priceSources="
				+ priceSources + ", pricesourcesenum=" + pricesourcesenum + ", memo=" + memo + ", dr=" + dr + "]";
	}
}