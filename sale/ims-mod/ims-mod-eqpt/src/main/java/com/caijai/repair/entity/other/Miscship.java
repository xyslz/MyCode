 ...
 *
 */
@Table(name = "eq_MiscShip")
public class Miscship extends BaseEntity {

	private static final long serialVersionUID = -8523944104018384635L;
	...
	public String toString() {
		return "Miscship [id=" + id + ", order=" + order + ", applicant=" + applicant + ", applicantName="
				...
				+ ", miscshipdoctype=" + miscshipdoctype + ", glclose=" + glclose + ", sobaccountperiod="
				+ sobaccountperiod + ", wfcurrentstate=" + wfcurrentstate + ", wforiginalstate=" + wforiginalstate
				+ ", curraction=" + curraction + ", approvedby=" + approvedby + ", approvedon=" + approvedon
				+ ", cancelapprovedby=" + cancelapprovedby + ", cancelapprovedon=" + cancelapprovedon + ", glclosedon="
				+ glclosedon + ", warnmessage=" + warnmessage + ", node=" + node + ", availableqtymessage="
				+ availableqtymessage + ", srcdoctype=" + srcdoctype + ", isunrealreturned=" + isunrealreturned
				+ ", isuncreateaai=" + isuncreateaai + ", benefitorg=" + benefitorg + ", handlepsn=" + handlepsn
				+ ", benefitpsn=" + benefitpsn + ", whman=" + whman + ", reversemiscship=" + reversemiscship
				+ ", istransfer=" + istransfer + ", flowinstance=" + flowinstance + ", memo=" + memo + ", dr=" + dr
				+ "]";
	}
