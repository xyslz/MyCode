 ...
 * @date 2019年4月11日
 */
@Table(name = "MO_Equipment")
public class Equipment extends BaseTable {

	
	private static final long serialVersionUID = 59087954095265136L;
	...
	public Integer getEquipmentCondition() {
		return equipmentCondition;
	}

	public void setEquipmentCondition(Integer equipmentCondition) {
