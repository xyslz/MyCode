...
public class SpotCheckRecordLine extends BaseTable {
	...
	public String toString() {
		return "SpotCheckRecordLine [id=" + id + ", currentState=" + currentState + ", operatState=" + operatState
				+ ", em=" + em + ", isRepair=" + isRepair + ", spotCheckRecord=" + spotCheckRecord
				+ ", spotCheckMethod=" + spotCheckMethod + ", spotCheckProject=" + spotCheckProject
				+ ", spotCheckProjectName=" + spotCheckProjectName + ", criterion=" + criterion + ", checkMethod="
				+ checkMethod + ", checkMethodName=" + checkMethodName + ", checkCycle=" + checkCycle + ", actValue="
				+ actValue + ", paramUpper=" + paramUpper + ", paramLower=" + paramLower + ", spotCheckResult="
				+ spotCheckResult + ", description=" + description + ", org=" + org + ", createdBy=" + createdBy
